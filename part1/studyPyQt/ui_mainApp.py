...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lblMessage.setGeometry(QtCore.QRect(10, 10, 251, 41))
        font = QtGui.QFont()
        font.setFamily("맑은 고딕")
        self.lblMessage.setFont(font)
        self.lblMessage.setObjectName("lblMessage")
        self.btnOK = QtWidgets.QPushButton(Form)
        self.btnOK.setGeometry(QtCore.QRect(180, 120, 81, 31))
        self.btnOK.setObjectName("btnOK")
        self.btnPOP = QtWidgets.QPushButton(Form)
        self.btnPOP.setGeometry(QtCore.QRect(90, 120, 81, 31))
